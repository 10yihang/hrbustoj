...
static PyCodeObject *codeobj_13ab82521de1df3cd1f618adf6188686;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[2]; CHECK_OBJECT(module_filename_obj);
    codeobj_13ab82521de1df3cd1f618adf6188686 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[45], mod_consts[45], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_13ab82521de1df3cd1f618adf6188686;
    ...
    frame_13ab82521de1df3cd1f618adf6188686 = MAKE_MODULE_FRAME(codeobj_13ab82521de1df3cd1f618adf6188686, module_lxml$html$defs);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_13ab82521de1df3cd1f618adf6188686);
    assert(Py_REFCNT(frame_13ab82521de1df3cd1f618adf6188686) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_13ab82521de1df3cd1f618adf6188686, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_13ab82521de1df3cd1f618adf6188686->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_13ab82521de1df3cd1f618adf6188686, exception_lineno);
    }



    assertFrameObject(frame_13ab82521de1df3cd1f618adf6188686);
    ...
    }
    {
        ...
        tmp_bitor_expr_left_3 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[23]);

        if (unlikely(tmp_bitor_expr_left_3 == NULL)) {
            tmp_bitor_expr_left_3 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[23]);
        }

        assert(!(tmp_bitor_expr_left_3 == NULL));
        tmp_bitor_expr_right_3 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[25]);

        if (unlikely(tmp_bitor_expr_right_3 == NULL)) {
            tmp_bitor_expr_right_3 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[25]);
        }
        ...
        tmp_bitor_expr_right_2 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[27]);

        if (unlikely(tmp_bitor_expr_right_2 == NULL)) {
            tmp_bitor_expr_right_2 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[27]);
        }
        ...
        tmp_bitor_expr_right_1 = mod_consts[28];
    ...
    }
    {
        ...
        tmp_bitor_expr_left_13 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[19]);

        if (unlikely(tmp_bitor_expr_left_13 == NULL)) {
            tmp_bitor_expr_left_13 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[19]);
        }

        assert(!(tmp_bitor_expr_left_13 == NULL));
        tmp_bitor_expr_right_13 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[21]);

        if (unlikely(tmp_bitor_expr_right_13 == NULL)) {
            tmp_bitor_expr_right_13 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[21]);
        }
        ...
        tmp_bitor_expr_right_12 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[23]);

        if (unlikely(tmp_bitor_expr_right_12 == NULL)) {
            tmp_bitor_expr_right_12 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[23]);
        }
        ...
        tmp_bitor_expr_right_11 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[25]);

        if (unlikely(tmp_bitor_expr_right_11 == NULL)) {
            tmp_bitor_expr_right_11 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[25]);
        }
        ...
        tmp_bitor_expr_right_10 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[27]);

        if (unlikely(tmp_bitor_expr_right_10 == NULL)) {
            tmp_bitor_expr_right_10 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[27]);
        }
        ...
        tmp_bitor_expr_right_9 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[31]);

        if (unlikely(tmp_bitor_expr_right_9 == NULL)) {
            tmp_bitor_expr_right_9 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[31]);
        }
        ...
        tmp_bitor_expr_right_8 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[33]);

        if (unlikely(tmp_bitor_expr_right_8 == NULL)) {
            tmp_bitor_expr_right_8 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[33]);
        }
        ...
        tmp_bitor_expr_right_7 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[35]);

        if (unlikely(tmp_bitor_expr_right_7 == NULL)) {
            tmp_bitor_expr_right_7 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[35]);
        }
        ...
        tmp_bitor_expr_right_6 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[37]);

        if (unlikely(tmp_bitor_expr_right_6 == NULL)) {
            tmp_bitor_expr_right_6 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[37]);
        }
        ...
        tmp_bitor_expr_right_5 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[43]);

        if (unlikely(tmp_bitor_expr_right_5 == NULL)) {
            tmp_bitor_expr_right_5 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[43]);
        }
        ...
        tmp_bitor_expr_right_4 = GET_STRING_DICT_VALUE(moduledict_lxml$html$defs, (Nuitka_StringObject *)mod_consts[41]);

        if (unlikely(tmp_bitor_expr_right_4 == NULL)) {
            tmp_bitor_expr_right_4 = GET_MODULE_VARIABLE_VALUE_FALLBACK(tstate, mod_consts[41]);
        }
