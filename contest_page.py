...
LastEditTime: 2023-08-29 18:53:43
Description: 爱自己最重要啦
QwQ 加油加油
'''
...
def goToproblem_info(list,contest_problemslist):
    ...
    if selection:
        ...
        # cpi.get_problem_info(url + '/' + contest_problemslist[problem])
        page = session.get(url + '/' + contest_problemslist[problem], headers=headers, data=data)
        # print(page.text)
